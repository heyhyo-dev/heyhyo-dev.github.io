...
### YCL_YGWSFLIGHT4_MPC_EXT 로직 변경하기
 
<mark>SEGW</mark>

<img src="/assets/images/ui5-gwprj1-mpc.png" />


날짜 데이터가 Nov 25, 2024, 9:00:00 AM => Nov 25, 2024 으로 조회되게 해당 메소드를 재정의한다.  
<details>
<summary>DEFINE 메소드 코드</summary>
<div markdown="1">
```abap
  METHOD DEFINE.
    ...
    DATA(LO_ENTITY_TYPE) = MODEL->GET_ENTITY_TYPE( IV_ENTITY_NAME = 'SflightEntity' ).
    DATA(LO_PROPERTY) = LO_ENTITY_TYPE->GET_PROPERTY( IV_PROPERTY_NAME = 'Fldate' ).
    DATA(LO_ODATA_ANNOTATION) = LO_PROPERTY->/IWBEP/IF_MGW_ODATA_ANNOTATABL~CREATE_ANNOTATION( /IWBEP/IF_MGW_MED_ODATA_TYPES=>GC_SAP_NAMESPACE ).

    LO_ODATA_ANNOTATION->ADD( IV_KEY = 'display-format' IV_VALUE = 'Date' ).
  ENDMETHOD.
```  
</div>
</details>
...
<details>
<summary>List.view 코드</summary>
<div markdown="1">
```xml
<mvc:View
    controllerName="gw1.controller.List"
    ...
    <f:DynamicPage id="idDynamicPage" showFooter="false">
...
appTitle=odata crudq

#YDES: Application description
appDescription=Fiori App with Smart Table
...
## 결과
*terminal - 해당 프로젝트 경로에서(cd project1) npm install(최초 한번만) / npm run start*  

 <img src="/assets/images/ui5-gwprj1-result.gif" />
